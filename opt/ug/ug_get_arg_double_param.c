...
/*
 * Get the value of a UG type double parameter from an array of arguments, the
 * UG input parameter file, or the UG parameter structure.
 *
 * UG LIB : Unstructured Grid - General Purpose Routine Library
 * $Id: ug_get_arg_double_param.c,v 1.5 2012/08/25 18:54:13 marcum Exp $
 ...
 */
  ...
  if (Get_Flag == 0 && UG_Param_Struct_Ptr)
    Get_Flag = ug_get_double_param (Param_Name, Double_Param_Value, UG_Param_Struct_Ptr);
