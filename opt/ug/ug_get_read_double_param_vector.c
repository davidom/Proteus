...
INT_ ug_get_read_double_param_vector
 (char Param_Name[],
...
/*
 * Get the values for a UG type double parameter vector from either the UG
 * parameter file or if not found there from the UG parameter structure.
 *
 * UG LIB : Unstructured Grid - General Purpose Routine Library
 * $Id: ug_get_read_double_param_vector.c,v 1.14 2012/08/25 18:54:13 marcum Exp $
