...
INT_ ug_get_arg_int_param_vector
 (char *argv[],
  char Param_Name[],
...
/*
 * Get the values for a UG type int parameter vector from an array of arguments,
 * the UG input parameter file, or the UG parameter structure.
 *
 * UG LIB : Unstructured Grid - General Purpose Routine Library
 * $Id: ug_get_arg_int_param_vector.c,v 1.6 2012/08/25 18:54:13 marcum Exp $
