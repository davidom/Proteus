...
/*
 * Compute total element volume.
 * 
 * UG3 LIB : Unstructured Grid - General Purpose Routine Library
 * 3D Version : $Id: ug3_tvol.c,v 1.4 2012/08/25 19:01:45 marcum Exp $
 ...
 */
  ...
  double dc0, dx211, dx212, dx213, dx311, dx312, dx313, dx411, dx412, dx413, 
         tvol, x11, x12, x13, x21, x22, x23, x31, x32, x33, x41, x42, x43;
  ...
  for (ielem = 1; ielem <= nelem; ++ielem)
  {
    ...
    tvol = tvol + dx211 * (dx312 * dx413 - dx313 * dx412)
