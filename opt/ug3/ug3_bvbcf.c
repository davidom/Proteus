...
/*
 * Determine a normal vector for each boundary node attached to a frozen
 * partition boundary face.
 * 
 * UG3 LIB : Unstructured Grid - General Purpose Routine Library
 * 3D Version : $Id: ug3_bvbcf.c,v 1.3 2012/08/25 19:01:45 marcum Exp $
