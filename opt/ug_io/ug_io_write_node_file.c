 ...
 * $Id: ug_io_write_node_file.c,v 1.10 2013/03/16 17:09:09 marcum Exp $
 ...
 */
  ...
  if (File_Type_Flag > 0)
  {
    ...
    {
      strcpy (Error_Message, "unable to open output node data file");
      return (640);
    }

    Error_Flag = ug_io_write_node (Node_Data_File, Error_Message, 
  ...
  { 
    strcpy (Error_Message, "unknown output node data file type");
    return (640);
  }
