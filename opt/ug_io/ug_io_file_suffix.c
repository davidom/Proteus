 ...
 * $Id: ug_io_file_suffix.c,v 1.9 2012/08/23 04:01:49 marcum Exp $
 ...
 */
  ...
  strcpy (File_Suffix, "");
  strcat (File_Suffix, File_Mode_Suffix_);
  strcat (File_Suffix, File_Format_Suffix_);
  strcat (File_Suffix, File_Type_Suffix_);
  strcat (File_Suffix, File_Compression_Suffix_);
