...
TEST(EntityIteratorTest, Creation)
{
  ...
  Proteus::entity_iterator<Proteus::entity_list<Proteus::Geometry::node3d>,std::vector<size_t>> ei(list,range);
}
...
TEST(EntityIteratorTest, IteratorWithAssociativeContainer)
{
  ...
  Proteus::entity_iterator<Proteus::entity_list<Proteus::Geometry::node3d>,Proteus::trait_adapter<std::map<size_t,double>>> ei(list,ta);
...
TEST(EntityIteratorTest, IteratorWithEntityTrait)
{
  ...
  Proteus::entity_iterator<Proteus::entity_list<Proteus::Geometry::node3d>,Proteus::trait_adapter<Proteus::entity_trait<double>>> ei(list,ta);
